/* TermQueryParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. TermQueryParserTokenManager.java */
package com.chanlp4j.query;

/** Token Manager. */
public class TermQueryParserTokenManager implements TermQueryParserConstants {
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public TermQueryParserTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public TermQueryParserTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
